...
<body>
    <header>
        <nav>
            <div class="row">
                <img src="./resource/assets/logo-white.png" alt="Omnifood logo" class="logo">
                <img src="./resource/assets/logo.png" alt="Omnifood logo" class="logo-black">
    ...
    <section class="section-features js--section-features" id="features">
        <div class="row">
            ...
            <p class="long-copy">
                Hello, we're Omnifood, your new premium food delivery service. We know you're always busy. No time for cooking. So let us
        ...
        <div class="row js--wp-1">
            <div class="col span-1-of-4 box">
                ...
                <p>
                    Never cook again! We really mean that. Our subscription plans include up to 365 days/year coverage. You can also choose to
            ...
            <div class="col span-1-of-4 box">
                ...
                <p>
                    We don't limit your creativity, which means you can order whatever you feel like. You can also choose from our menu containing
        ...
        <ul class="meals-showcase clearfix">
            <li>
                <figure class="meal-photo">
                    <img src="./resource/assets/1.jpg" alt="Korean bibimbap with egg and vegetables">
                </figure>
            </li>
            <li>
                <figure class="meal-photo">
                    <img src="./resource/assets/2.jpg" alt="Simple italian pizza with cherry tomatoes">
                </figure>
            </li>
            <li>
                <figure class="meal-photo">
                    <img src="./resource/assets/3.jpg" alt="Chicken breast steak with vegetables">
                </figure>
            </li>
            <li>
                <figure class="meal-photo">
                    <img src="./resource/assets/4.jpg" alt="Autumn pumpkin soup">
                </figure>
            </li>
        </ul>
        <ul class="meals-showcase clearfix">
            <li>
                <figure class="meal-photo">
                    <img src="./resource/assets/5.jpg" alt="Paleo beef steak with vegetables">
                </figure>
            </li>
            <li>
                <figure class="meal-photo">
                    <img src="./resource/assets/6.jpg" alt="Healthy baguette with egg and vegetables">
                </figure>
            </li>
            <li>
                <figure class="meal-photo">
                    <img src="./resource/assets/7.jpg" alt="Burger with cheddar and bacon">
                </figure>
            </li>
            <li>
                <figure class="meal-photo">
                    <img src="./resource/assets/8.jpg" alt="Granola with cherries and strawberries">
                </figure>
            </li>
        </ul>
    </section>
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            <div class="col span-1-of-2 steps-box">
                <img src="./resource/assets/app-iPhone.png" alt="Omnifood app on iPhone" class="app-screen js--wp-2">
            </div>
            <div class="col span-1-of-2 steps-box">
                ...
                <a href="#" class="btn-app">
                    <img src="./resource/assets/download-app.svg" alt="App Store Button">
                </a>
                <a href="#" class="btn-app">
                    <img src="./resource/assets/download-app-android.png" alt="Play Store Button">
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="section-cities" id="cities">
        ...
        <div class="row js--wp-3">
            <div class="col span-1-of-4 box">
                <img src="./resource/assets/lisbon-3.jpg" alt="Lisbon">
                <h3>Lisbon</h3>
            ...
            <div class="col span-1-of-4 box">
                <img src="./resource/assets/san-francisco.jpg" alt="San Francisco">
                <h3>San Francisco</h3>
                <div class="city-feature">
                    <i class="ion-ios-person icon-small"></i>
                    3700+ happy eaters
            ...
            <div class="col span-1-of-4 box">
                <img src="./resource/assets/berlin.jpg" alt="Berlin">
                <h3>Berlin</h3>
                <div class="city-feature">
                    <i class="ion-ios-person icon-small"></i>
                    2300+ happy eaters
            ...
            <div class="col span-1-of-4 box">
                <img src="./resource/assets/london.jpg" alt="London">
                <h3>London</h3>
                <div class="city-feature">
                    <i class="ion-ios-person icon-small"></i>
                    1200+ happy eaters
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite>
                        <img src="./resource/assets/customer-1.jpg" alt="Customer 1 photo">Alberto Duncan</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite>
                        <img src="./resource/assets/customer-2.jpg" alt="Customer 2 photo">Joana Silva</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite>
                        <img src="./resource/assets/customer-3.jpg" alt="Customer 3 photo">Milton Chapman</cite>
                </blockquote>
            </div>
        </div>
    </section>
                ...
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            ...
                            <li>
                                <i class="ion-ios-checkmark-empty icon-small"></i>Order from 8 am to 12 pm</li>
                            <li>
